...
.pub-year-group { margin-top: 1.6em; }
.pub-year-group h2 {
  font-size: 0.95em;
  color: #999;
...
.pub-entry:hover { border-left-color: #aaa; }
.pub-entry.hidden { display: none; }
.pub-title { font-size: 0.92em; font-weight: bold; margin: 0 0 0.2em; line-height: 1.4; }
.pub-title a { color: #267CB9; text-decoration: none; }
.pub-title a:hover { text-decoration: underline; }
.pub-authors { font-size: 0.82em; color: #555; margin: 0 0 0.15em; line-height: 1.4; }
.pub-authors strong { color: #222; }
.pub-venue { font-size: 0.82em; color: #777; font-style: italic; margin: 0; }
.pub-tags { margin-top: 0.4em; display: flex; flex-wrap: wrap; gap: 4px; }
.pub-tag {
  font-size: 0.72em; padding: 2px 7px;
  border-radius: 3px; background: #f0f0f0;
  color: #555; border: 1px solid #ddd;
}
#no-results { display: none; font-size: 0.9em; color: #999; padding: 1em 0; }
</style>
...
<div class="pub-year-group" data-year-group="2023">
<h2>2023</h2>

<div class="pub-entry" data-year="2023" data-topics="taxonomy">
...
<div class="pub-year-group" data-year-group="2021">
<h2>2021</h2>

<div class="pub-entry" data-year="2021" data-topics="phylogenetics">
...
<div class="pub-year-group" data-year-group="2019">
<h2>2019</h2>

<div class="pub-entry" data-year="2019" data-topics="root-development">
...
<div class="pub-year-group" data-year-group="2018">
<h2>2018</h2>

<div class="pub-entry" data-year="2018" data-topics="cactaceae root-development transcriptomics">
...
function applyFilters() {
  ...
  entries.forEach(function(entry) {
    var matchYear = year === 'all' || entry.dataset.year === year;
    var matchTopic = topic === 'all' || entry.dataset.topics.split(' ').indexOf(topic) > -1;
  ...
  document.querySelectorAll('.pub-year-group').forEach(function(group) {
    var hasVisible = group.querySelectorAll('.pub-entry:not(.hidden)').length > 0;
